...
public class StatistiqueEmploye extends AppCompatActivity {
    ...
    private float[] yData ={2, 3 } ;
    private String[] xData = {"Femme", "Homme" };
    PieChart pieChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistique_employe);
        ...
        pieChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(StatistiqueEmploye.this, "Employee " + employee + "\n" + "Sales: $" + sales + "K", Toast.LENGTH_LONG).show();
            }
    ...
    private void addDataSet() {
        ...
        //create the data set
        PieDataSet pieDataSet = new PieDataSet(yEntrys, "Employee Sexe");
